...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { paragraph: 'You\'re not just merging numbers like some soulless puzzle robot. EvoFuse2048 has themes. Want to merge the history of the world? 🏛️ Merge your love story from "Awkward First Date" to "Happily Ever After"? 💘 Or how about "Judy Hopps\' Evolution from Carrot Farmer to Badass Cop"? 🐰💥' },
      ...
      { paragraph: '⬆️ Upgrade: Double a tile\'s value and watch chaos unfold' },
